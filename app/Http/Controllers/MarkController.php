...
class MarkController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            $exams = $examRepository->getExmanesparaCalificar($current_school_session_id, $semester_id, $course_id, $section_id);
            $markRepository = new MarkRepository();

           // dd($current_school_session_id, $semester_id, $class_id, $section_id, $course_id);
            ...
            //dd($studentsWithMarks);            

            //$semesters = $this->semesterRepository->getAll($current_school_session_id);

            $StudentsList = $this->userRepository->getAllStudents($current_school_session_id, $class_id, $section_id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return back()->with('status', 'Calificación guardada con éxito!');
        } catch (\Exception $e) {
            return back()->with('status', 'Calificación guardada con éxito!');
        }
    }
    ...
    public function storeFinalMark(Request $request) {
        ...
        try {
            ...
            return back()->with('status', 'Calificación final enviada con éxito!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
