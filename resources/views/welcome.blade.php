...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top text-center min-h-screen sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 underline">@lang('Home')</a>
                    @else
                        <a href="{{ route('login') }}" class="text-gray-900 dark:text-white" style="border: 1px solid #1a202c;padding: 5px;border-radius: 5px;">@lang('Login')</a>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center" style="align-items: center;">
                   <a href="{{ url('/home') }}"> <img src="imgs/logo-2.png" style="width: 80%;"></a>
                </div>
            </div>
        </div>
    </body>
