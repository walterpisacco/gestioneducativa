            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> @lang('View Results')
                    </h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select onchange="getSectionsAndCourses(this);" class="form-select" name="class_id" aria-label="Class">
                                        @isset($classes)
                                            <option selected disabled>@lang('Please select a class')</option>
...
<script>
    function getSectionsAndCourses(obj) {
        ...
        .then(function(data) {
            ...
            data.sections.unshift({'id': 0,'section_name': 'Por favor seleccione uno'})
            ...
            data.courses.unshift({'id': 0,'course_name': 'Por favor seleccione uno'})
