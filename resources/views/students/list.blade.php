                        ...
                        <div class="card bg-white border shadow-sm p-3">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-4">
                                    <a href="{{route('student.create.show')}}" style="width:100%" id="btnAgregar" type="button" class="btn btn-sm btn-primary">@lang('Add')</a>
                                </div>
                                @endcan
                                @can ('import users')
                                <div class="col-md-2 mb-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{url('students/view/profile/'.$student->student->id)}}" role="button" class="btn btn-sm btn-primary"><i class="bi bi-eye"></i> @lang('Profile')</a>
                                                @can('edit users')
                                                <a href="{{route('student.edit.show', ['id' => $student->student->id])}}" role="button" class="btn btn-sm btn-warning"><i class="bi bi-pen"></i> @lang('Edit')</a>
                                                @endcan
                                                @can('delete users')
                                                <button onClick="btnEliminar({{$student->student->id}})" id="btnEliminar" type="button" class="btn btn-sm btn-danger btnEliminar"><i class="bi bi-trash2"></i> @lang('Delete')</button>
                                                @endcan
                                            </div>
                                        </td>
                                    </tr>
