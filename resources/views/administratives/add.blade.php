            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> @lang('Add Administrative')</h1>
                    ...
                    <div class="card mb-4 p-3 bg-white border shadow-sm">
                        <form action="{{route('administrative.create')}}" method="POST">
                            @csrf
                            <div class="row mb-4">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <label for="inputRol" class="form-label">@lang('Perfil')</label>
                                    <select id="inputRol" class="form-select" name="rol" required>
                                        <option value="directivo" {{old('directivo') == 'Directivo' ? 'selected' : ''}}>@lang('Director')</option>
                                        <option value="preceptor" {{old('preceptor') == 'Preceptor' ? 'selected' : ''}}>@lang('Preceptor')</option>
                                        <option value="administrativo" {{old('administrative') == 'Administrativo' ? 'selected' : ''}}>@lang('Administrative')</option>
                                    </select>
                                </div>                                
                            </div>
                            <div class="row mb-4">
